...
if($_POST[setid] == $_SESSION[setid])
{
	if(isset($_POST[Submit]))
	{
		...
		{			
			$sqlins="INSERT into qualification(RegNo,Qualification,YOP,BoardOfExamination,AvgMarks)VALUES('$_SESSION[regno]','$_POST[Qualification]','$_POST[YOP]','$_POST[BoardOfExamination]','$_POST[AvgMarks]')";
					if(!mysqli_query($con,$sqlins))
					{
					$qrst="<font color='red'><h3>Failed to insert record in database...</h3></font>".mysqli_error($con);
					}
					else
					{
